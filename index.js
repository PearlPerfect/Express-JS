...
const schmea = {
    ...
    PASSWORD: {trim: true, isStrongPassword: { errorMessage: '**Must contain Upper and lowercases with Number and Special Character**' } },
}
//default route ...post
app.post("", checkSchema(schmea),
    // body("USERNAME").trim().isAlpha().withMessage("**Input Your Name**"),
    // body("PASSWORD").trim().isStrongPassword().withMessage("**Must Contain upper and lowercase letters "),
    function (req, res) {
